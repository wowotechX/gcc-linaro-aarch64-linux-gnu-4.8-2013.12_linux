...
enum opt_code
{
  ...
  OPT_march_ = 1038,                         /* -march= */
  OPT_mbig_endian = 1039,                    /* -mbig-endian */
  OPT_mbionic = 1040,                        /* -mbionic */
  OPT_mcmodel_ = 1041,                       /* -mcmodel= */
  OPT_mcpu_ = 1042,                          /* -mcpu= */
  OPT_mgeneral_regs_only = 1043,             /* -mgeneral-regs-only */
  OPT_mglibc = 1044,                         /* -mglibc */
  OPT_mlittle_endian = 1045,                 /* -mlittle-endian */
  OPT_momit_leaf_frame_pointer = 1046,       /* -momit-leaf-frame-pointer */
  OPT_mstrict_align = 1047,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1048,                  /* -mtls-dialect= */
  OPT_mtune_ = 1049,                         /* -mtune= */
  OPT_muclibc = 1050,                        /* -muclibc */
  OPT_n = 1051,                              /* -n */
  OPT_no_canonical_prefixes = 1052,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1053,              /* -no-integrated-cpp */
  OPT_nocpp = 1054,                          /* -nocpp */
  OPT_nodefaultlibs = 1055,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1056,                   /* -nostartfiles */
  OPT_nostdinc = 1057,                       /* -nostdinc */
  OPT_nostdinc__ = 1058,                     /* -nostdinc++ */
  OPT_nostdlib = 1059,                       /* -nostdlib */
  OPT_o = 1060,                              /* -o */
  OPT_p = 1061,                              /* -p */
  OPT_pass_exit_codes = 1062,                /* -pass-exit-codes */
  /* OPT_pedantic = 1063, */                 /* -pedantic */
  OPT_pedantic_errors = 1064,                /* -pedantic-errors */
  OPT_pg = 1065,                             /* -pg */
  OPT_pie = 1066,                            /* -pie */
  OPT_pipe = 1067,                           /* -pipe */
  OPT_posix = 1068,                          /* -posix */
  OPT_print_file_name_ = 1069,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1070,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1071,          /* -print-multi-directory */
  OPT_print_multi_lib = 1072,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1073,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1074,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1075,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1076,               /* -print-prog-name= */
  OPT_print_search_dirs = 1077,              /* -print-search-dirs */
  OPT_print_sysroot = 1078,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1079,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1080,                        /* -profile */
  OPT_pthread = 1081,                        /* -pthread */
  OPT_quiet = 1082,                          /* -quiet */
  OPT_r = 1083,                              /* -r */
  OPT_rdynamic = 1084,                       /* -rdynamic */
  ...
  OPT_time = 1137,                           /* -time */
  OPT_time_ = 1138,                          /* -time= */
  OPT_tno_android_cc = 1139,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1140,                 /* -tno-android-ld */
  OPT_traditional = 1141,                    /* -traditional */
  OPT_traditional_cpp = 1142,                /* -traditional-cpp */
  OPT_trigraphs = 1143,                      /* -trigraphs */
  OPT_u = 1144,                              /* -u */
  OPT_undef = 1145,                          /* -undef */
  OPT_v = 1146,                              /* -v */
  OPT_version = 1147,                        /* -version */
  OPT_w = 1148,                              /* -w */
  OPT_wrapper = 1149,                        /* -wrapper */
  OPT_x = 1150,                              /* -x */
  OPT_z = 1151,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
